...
LIB_SRC  := src/orderBook.cpp src/fastOrderBook.cpp
...
$(BUILD)/orderbook_demo: src/main.cpp src/orderBook.cpp | $(BUILD)
...
run-bench: $(BUILD)/orderbook_bench
	./$(BUILD)/orderbook_bench --events=3000000 --reps=5 --capacity=131072
